  ...
  return (
    <div className="space-y-8 max-w-2xl">
      ...
      <SectionCard
        ...
        icon={Shield}
      >
        <div className="p-4 rounded-xl border border-red-400/15 bg-red-400/5">
          <p className="text-sm font-medium text-red-400 mb-1">Desativar conta</p>
          <p className="text-xs text-neutral-500 mb-4">
            Isso irá desativar seu acesso ao painel. A ação pode ser revertida pelo suporte.
          </p>
          <button className="px-4 py-2 text-xs font-semibold text-red-400 border border-red-400/30 rounded-xl hover:bg-red-400/10 transition-colors">
